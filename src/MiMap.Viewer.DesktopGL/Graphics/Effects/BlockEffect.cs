...
namespace MiMap.Viewer.DesktopGL.Graphics.Effects
{
    ...
    public class BlockEffect : Microsoft.Xna.Framework.Graphics.Effect, IEffectMatrices, IEffectFog
    {
        ...
        public BlockEffect() : base(MiMapViewer.Instance.Content.Load<Effect>("Effects/BlockEffect"))
        {
            CacheEffectParameters();
        }
