...
namespace MiMap.Viewer.DesktopGL.Components
{
    ...
    public class DebugGrid : GameComponent
    {
        public int Steps
        {
            get => _steps;
        ...
        public void CalculateVerticies()
        {
            ...
            if (arraySize != _vertexBuffer.VertexCount) 
                Init(MiMapViewer.Instance.GraphicsDevice);
        ...
        public void Draw(Matrix view, Matrix projection)
        {
            ...
            foreach (EffectPass pass in _effect.CurrentTechnique.Passes)
            {
                ...
                Game.GraphicsDevice.DrawUserPrimitives(PrimitiveType.LineList, _verticies, 0, _verticies.Length / 2);
            }
        }

        public DebugGrid(Game game) : base(game)
        {
        }
    }
}